(function() {
  ...
  toggleButton.addEventListener("click", function() {
      ...
      transitionCover.classList.add('transition-cover');
      document.body.appendChild(transitionCover);
      setTimeout(() => {
          transitionCover.style.clipPath = 'circle(100%)';
      }, 10); // Ensure immediate clip-path transition
      ...
      setTimeout(() => {
          ...
          setTimeout(() => {
              document.body.removeChild(transitionCover);
              document.body.classList.remove('color-transition');
          }, 1000);
      }, 500); // Shorter delay for the switch effect to start
  });
